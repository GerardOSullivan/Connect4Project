...
public class Frame extends JFrame{
    public Frame()
    {
        ...
        //the boundaries are then set and the JLabel is added to the frame. The video did not have the get width and height accessors. I put them in encase I had to change the frame.

        //adding the shapes for the grid to the board
        frame.add(new DrawShapes(frame.getSize()));

        JLabel backgroundImage = new JLabel(new ImageIcon(getClass().getResource("Connect4Background.jpg")));
