...
public class Frame extends JFrame{
    ...
    public Frame()
    {
        ...
        //the boundaries are then set and the JLabel is added to the frame. The video did not have the get width and height accessors. I put them in incase I had to change the frame.
